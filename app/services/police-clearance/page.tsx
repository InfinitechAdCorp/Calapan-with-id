    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Learn how to obtain your police clearance certificate in Calapan City</p>
        </div>
          ...
          <CardHeader>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Police clearance is processed directly by the Philippine National Police (PNP). The City Government of Calapan does not issue police clearance certificates.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Where to Apply in Calapan City
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="bg-orange-50 p-4 rounded-lg">
              ...
              <div className="space-y-1 text-sm text-gray-700">
                <p>
                  <strong>Address:</strong> Calapan City Police Station, Oriental Mindoro
                </p>
                <p>
            ...
            <ol className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: "Go to Calapan City Police Station or your barangay police station",
                },
                {
