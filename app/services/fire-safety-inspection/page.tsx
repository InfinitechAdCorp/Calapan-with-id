    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Learn how to get your Fire Safety Inspection Certificate (FSIC) in Calapan City</p>
        </div>
          ...
          <CardHeader>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Fire Safety Inspection Certificate (FSIC) is processed directly by the Bureau of Fire Protection (BFP). The City Government of Calapan does not issue FSIC. Please visit the BFP Calapan City Fire Station.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent>
            <div className="bg-orange-50 p-4 rounded-lg">
              <h4 className="font-semibold mb-2 flex items-center gap-2">
                ...
                Bureau of Fire Protection - Calapan City
              </h4>
              <div className="space-y-1 text-sm text-gray-700">
                <p>
                  <strong>Office:</strong> BFP Calapan City Fire Station
                </p>
                <p>
                  <strong>Address:</strong> Calapan City, Oriental Mindoro
                </p>
                <p>
                  <strong>Office Hours:</strong> Monday to Friday, 8:00 AM - 5:00 PM
                </p>
                <p className="text-xs text-gray-600 mt-2">
                  Note: Contact the BFP Calapan office for exact location and to schedule your inspection
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            <ol className="space-y-3">
              {[
                ...
                {
                  title: "Visit BFP Calapan",
                  desc: "Go to BFP Calapan Fire Station and submit application form with requirements",
                },
                {
          ...
          <CardContent>
            ...
            <div className="bg-gray-50 p-4 rounded-lg space-y-2 text-sm">
              ...
              <p className="text-xs text-gray-600 mt-3">
                Note: Exact fees should be confirmed with BFP Calapan office as rates may vary
              </p>
            </div>
          </CardContent>
        </Card>
