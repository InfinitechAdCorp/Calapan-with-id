...
export async function GET(request: NextRequest) {
  try {
    ...
    const url = id ? `${API_URL}/api/barangay-clearance/${id}` : `${API_URL}/api/barangay-clearance`
...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${API_URL}/api/barangay-clearance`, {
      method: "POST",
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${API_URL}/api/barangay-clearance/${id}`, {
      method: "POST",
      body: snakeCaseFormData,
    })
